...
pub async fn run_wizard(force: bool) -> Result<Config> {
    ...
    let config = Config {
        ...
        x: crate::config::XConfig::default(),
        agentphone: crate::config::AgentPhoneConfig::default(),
        budget: crate::config::BudgetConfig::default(),
        issue_tracker: crate::config::IssueTrackerConfig::default(),
        nutrition: crate::config::NutritionConfig::default(),

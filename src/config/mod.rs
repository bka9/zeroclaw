...
pub use schema::{
    ...
    BackupConfig, BrowserComputerUseConfig, BrowserConfig, BuiltinHooksConfig,
    ...
    HardwareConfig, HardwareTransport, HealthConfig, HeartbeatConfig, HooksConfig,
    ...
    ShellToolConfig, SkillCreationConfig, SkillImprovementConfig, SkillsConfig,
